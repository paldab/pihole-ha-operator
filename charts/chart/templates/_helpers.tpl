...
*/}}
{{- define "pihole-ha-operator.name" -}}
...
*/}}
{{- define "pihole-ha-operator.fullname" -}}
...
*/}}
{{- define "pihole-ha-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "pihole-ha-operator.resourceName" -}}
{{- $fullname := include "pihole-ha-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "pihole-ha-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "pihole-ha-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
